...
from ceda.tds_ogc_scan.test.test_wms import TdsCatalogServiceTestCase
...
def main():
    ...
    nagios_script(TdsCatalogServiceTestCase, check_name='CCI_WMS_TEST',
                  unittest_module=ceda.tds_ogc_scan.test.test_wms,
